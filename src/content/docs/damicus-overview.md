...
lastSynced: "2026-09-07T13:33:25.128Z"
---
...
<span style="color:#1b2a9e"><em>Version 1.0 Draft 2· September 2026</em></span>
...
•    **Classify** <span style="color:#1d1d1d">AI solutions based on key criteria that are relevant to adoption in a corporate context, describing these classes with compact, unambiguous codes</span>

•    <span style="color:#2b2b2b"><strong>Define policies</strong></span> <span style="color:#2b2b2b">&nbsp;outlining which classes of AI solutions are acceptable for an organization’s internal operations, partners and collaborators</span>
...
*   <span style="color:#1d1d1d">for each dimension, define a set of options, or positions, identified by simple, easy-to-remember codes.</span>
...
**Da-M-I-C-Us** defines five dimensions, **Da**ta, **M**odel, **I**nfrastructure, **C**ode and **Us**<span style="color:#1d1d1d">e. Each one of them defines one of the key aspects that should be considered when assessing a solution: which data was used to train the system? Who owns the models and what restrictions are in place? Where is the data processed during inference? Who owns the relevant code and what restrictions are in place? What is the solution used for?</span>

<span style="color:#1d1d1d">For each dimension Da-M-I-C-Us defines a small set of options, identified by a unique two letters code.</span>
...
*   **Deployment Classification**<span style="color:#1d1d1d">: a solution classification with the Use value added, describing how a specific organisation adopts it</span>
...
<table><tbody><tr><td colspan="1" rowspan="1"><p><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 56.00px; height: 56.00px;"><img alt="" src="/AI/doc-images/damicus/dde94c1b1b.png" style="width: 56.00px; height: 56.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p></td><td colspan="1" rowspan="1"><p><span style="color:#1b2a9e"><strong>SI</strong></span></p></td><td colspan="1" rowspan="1"><p><span style="color:#2b2b2b"><strong>Self-Managed Infrastructure</strong></span><span style="color:#2b2b2b">&nbsp;- Runs on infrastructure the organisation fully administers, on-premise hardware or self-managed cloud (IaaS) where the organisation controls images, networking and access.</span></p></td></tr><tr><td colspan="1" rowspan="1" style="background-color:#ebe4d8"><p><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 56.00px; height: 56.00px;"><img alt="" src="/AI/doc-images/damicus/708e5a3b5e.png" style="width: 56.00px; height: 56.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p></td><td colspan="1" rowspan="1" style="background-color:#ebe4d8"><p><span style="color:#1b2a9e"><strong>EI</strong></span></p></td><td colspan="1" rowspan="1" style="background-color:#ebe4d8"><p><span style="color:#2b2b2b"><strong>Edge Infrastructure</strong></span><span style="color:#2b2b2b">&nbsp;- Inference runs locally on end-user devices (workstation, mobile, embedded), typically with vendor-distributed weights.</span></p></td></tr><tr><td colspan="1" rowspan="1"><p><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 56.00px; height: 56.00px;"><img alt="" src="/AI/doc-images/damicus/47c6aad607.png" style="width: 56.00px; height: 56.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p></td><td colspan="1" rowspan="1"><p><span style="color:#1b2a9e"><strong>DI</strong></span></p></td><td colspan="1" rowspan="1"><p><span style="color:#2b2b2b"><strong>Dedicated Infrastructure</strong></span><span style="color:#2b2b2b">&nbsp;- Vendor-managed but logically or physically isolated for the customer: single-tenant SaaS, customer VPC deployments</span></p></td></tr><tr><td colspan="1" rowspan="1" style="background-color:#e4dbd0"><p><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 56.00px; height: 56.00px;"><img alt="" src="/AI/doc-images/damicus/9e5bfd1322.png" style="width: 56.00px; height: 56.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p></td><td colspan="1" rowspan="1" style="background-color:#e4dbd0"><p><span style="color:#1b2a9e"><strong>MI</strong></span></p></td><td colspan="1" rowspan="1" style="background-color:#e4dbd0"><p><span style="color:#2b2b2b"><strong>Multi-Tenant Infrastructure</strong></span><span style="color:#2b2b2b">&nbsp;- Standard shared SaaS or public API; the vendor controls the environment and serves many customers from shared infrastructure.</span></p></td></tr></tbody></table>
...
<span style="color:#1b2a9e"><strong>Da:&lt;Data&gt;-M:&lt;Model&gt;-I:&lt;Infra&gt;-C:&lt;Code&gt;</strong></span>

<span style="color:#1b2a9e"><strong>Example: &nbsp;Da:WD-M:CM-I:MI-C:CC</strong></span>

### <span style="color:#1a36b4">6.2 &nbsp; Deployment classification (adds the deployment dimension)</span>

Describes how one organisation _uses_ <span style="color:#1d1d1d">&nbsp;a capability. It takes a capability classification and supplies the missing Use value (confirming Infrastructure where the adopter chose it), defining all five dimensions. This is the object a policy is checked against.</span>

<span style="color:#1b2a9e"><strong>Da:&lt;Data&gt;-M:&lt;Model&gt;-I:&lt;Infra&gt;-C:&lt;Code&gt;-Us:&lt;Use&gt;</strong></span>

<span style="color:#1b2a9e"><strong>Example: &nbsp;Da:WD-M:CM-I:MI-C:CC-Us:PU</strong></span>
...
**Adaptation composes with “+”.** <span style="color:#1d1d1d">Fine-tunes, LoRAs and similar solutions compose within the Data (and where relevant Model) dimension as described earlier, preserving both the base and the adaptation in the string.</span>
...
<span style="color:#1b2a9e"><strong>Da:WD - M:CM - I:MI - C:CC</strong></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 678.00px; height: 147.00px;"><img alt="" src="/AI/doc-images/damicus/1e520e17a9.png" style="width: 720.00px; height: 383.75px; margin-left: -30.00px; margin-top: -69.13px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span>

**What it is.** <span style="color:#1d1d1d">A large, general-purpose model trained on web-collected data, with closed weights, served as a multi-tenant API or web application, on closed source.</span>

**Typical instances.** <span style="color:#1d1d1d">The dominant shape of general-purpose commercial AI. Chat and coding assistants; image, video and audio generators offered as hosted services by major providers.</span>

**Key characteristic.** <span style="color:#1d1d1d">Maximum capability with opacity on training-data provenance</span>

### C2   Rights-Cleared Commercial Model

<span style="color:#1b2a9e"><strong>Da:LD - M:CM - I:MI - C:CC</strong></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 691.00px; height: 162.98px;"><img alt="" src="/AI/doc-images/damicus/3690755e62.png" style="width: 720.00px; height: 383.98px; margin-left: -16.00px; margin-top: -59.98px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span>

**What it is.** <span style="color:#1d1d1d">Similar to C1, but the provider documents or warrants a licensed or owned training corpus.</span>
...
<span style="color:#1b2a9e"><strong>Da:WD - M:RM - I:SI - C:RC</strong></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 694.00px; height: 163.00px;"><img alt="" src="/AI/doc-images/damicus/7647ee382d.png" style="width: 720.00px; height: 384.02px; margin-left: -11.00px; margin-top: -58.98px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span>

**What it is.** <span style="color:#1d1d1d">An open-weights model whose licence restricts use (non-commercial, field-of-use or geographical &nbsp;limits), often with restrictive source terms.</span>

**Typical instances.** <span style="color:#1d1d1d">Research project checkpoints; non-commercial community models; “open but not for commercial use” releases.</span>
...
**Typical instances.** <span style="color:#1d1d1d">Internal forecasting or classifier model; Internal computer vision or image processing solutions e.g. image denoising.</span>
...
## 9   Common policy <span style="color:#1a36b4">&nbsp;classes</span>
...
**Typical instances.** <span style="color:#1d1d1d">In-house forecasting, scheduling, search; image denoising trained on proprietary data.</span>
...
**What it permits.** <span style="color:#1d1d1d">Commercial vendor-hosted assistants and productivity services, consumed under an organisational agreement, used anywhere short of generated content persisting into deliverables. Training-data provenance is unconstrained precisely because Use is limited to supporting operations and the output of the system is not present in any deliverable</span>
...
**Boundary.** <span style="color:#1d1d1d">Excludes consumer/free tiers and personal accounts accessed without an organisational agreement. Excludes any deployment where output reaches a deliverable.</span>
...
**What it permits.** <span style="color:#1d1d1d">Research releases, such as papers with code, restricted-licence checkpoints, unlicensed reference implementations, are admitted for internal evaluation only, on self-managed infrastructure so that no confidential material leaves the organisation during testing.</span>

**Typical instances.** <span style="color:#1d1d1d">Reproducing a paper's results; testing an unlicensed implementation to decide whether to seek a licence.</span>
...
### P5   Cleared Deliverable <span style="color:#1a36b4">Creation</span>
...
**What it permits.** <span style="color:#1d1d1d">Generative content that reaches deliverables, where the training data is rights-cleared (LD) or the organisation's own (PD).</span>
...
[\[a\]](#cmnt_ref1)<span style="color:#000000">Everything we have so far is relatively agnostic to the industry, but for this particular dimension, I am seeing some differences with how we consider generative elements affecting only background visuals vs actors.</span>

<span style="color:#000000">I wonder if we should consider splitting this into:</span>

<span style="color:#000000">BU - Direct use for background creation</span>

<span style="color:#000000">AU - Direct use on actors</span>

<span style="color:#000000">If we could find a more generic term than "Actors" it would be ideal</span>

[\[b\]](#cmnt_ref2)<span style="color:#000000">Is there something significant&nbsp;about it being a "Frontier" model? It makes me think of Bleeding edge models, which I dont think is what you are thinking? Would "Standard Commerical model" or "Opaque Commercial model" make more sense?</span>

[\[c\]](#cmnt_ref3)<span style="color:#000000">Valid point. With this Class, we really want to capture the OpenAI, Claude, Gemini etc. Simply calling it Standard Commercial model or Opaque model could then be referencing something that is self hosted etc.&nbsp;</span> 

<span style="color:#000000">You are right though, it does not necessarily mean "State of the Art" in this context</span>

<span style="color:#000000">Could be "Online Commercial Model"?</span>

[\[d\]](#cmnt_ref4)<span style="color:#000000">That seems better.</span>